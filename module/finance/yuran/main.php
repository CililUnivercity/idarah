...
<br>
<form class="form-horizontal" action="?page=finance&&financepage=yuranSearch" method="POST">
    <div class="form-group">
        ...
        <div class="col-lg-10 col-lg-offset-5">
            <button type="submit" class="btn btn-success btn-sm" name="save"><span class="glyphicon glyphicon-search"></span> SEARCH</button>
        </div>
    </div> 
</form>