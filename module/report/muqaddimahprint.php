...
<html lang="en">
    ...
    <?php
        ...
        $sql = mysqli_query($con, "SELECT s.*,m.* FROM students s 
             ...
             WHERE s.ft_id='$faculty_s' and s.dp_id='$department_s' and s.income_year='$year_s' and m.m_academicyear='$year_s' ORDER BY s.gender,s.student_id");
                ...
                <table width="100%">
                    <tr align="center">
                        <td align="center">
                            ...
                            <font size="4px">مقدمة   تاهون اكاديميك <?= $year_s ?></font><br>
