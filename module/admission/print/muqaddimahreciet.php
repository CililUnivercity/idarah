...
<html lang="en">
    ...
    <?php
        include '../../../connect.php';
        $id = $_GET['id'];
        $odrNumber = $_GET['odrNumber'];
        //$year = $_GET['year'];
        
        $sql_payment = mysqli_query($con, "SELECT m.*,s.* FROM muqaddimah_pay m
                     INNER JOIN students s ON m.st_id=s.st_id
                     WHERE m.st_id='$id'
                     ");
	...
	<body>			
			...
			<td align="right"><font size="2px">เลขที่ : <?= $rs_payment['m_reciet']; ?></font></td>
                    </tr>
                    <tr>
			<td align="center"><font size="2px">สถาบันอิสลามศึกษาชั้นสูง เช็คดาวุดอัลฟาฎอนีอัลอิสลามียะห์</font></td>
			<td align="right"><font size="2px">วันที่ : <?= $rs_payment['m_paydate']; ?></font></td>
                    </tr>
                    <tr>
		...
		<table width="595" border="0px" align="center">
			...
			<td width="162" align="center"><?= $odrNumber ?></td>
                    </tr>
                    <tr>
		...
		<table width="597" height="196" border="1px"  align="center">
			...
			<td width="154" align="center"><b>จำนวนเงิน / Amount</b></td>
                    ...
                    <tr>
			<td colspan="2" align="left">	ค่าเทอมนักศึกษา</td>
                        <td align="right"></td>
                    </tr>
                    <tr>
			<td colspan="2" align="left">	ค่าธรรมเนียม </td>
			<td align="right"><?= number_format($rs_payment['m_money']) ?>.00</td>
                    </tr>
                    <tr>
