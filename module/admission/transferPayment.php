...
<?php
    ...
    if($rowPaycheck > 0 ){
        ...
        $reciet = "<a href='module/admission/print/muqaddimahreciet.php?id=$st_id&&odrNumber=$odrNumber' class='btn btn-success btn-sm' target='_blank'><span class='glyphicon glyphicon-print'></span> RESIT</a>";
    }else{
