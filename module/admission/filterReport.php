...
<div class="col-lg-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            ?>
                <tr align="center">
                    <td align="center"><a href="?page=admissions&&admissionpage=filterPrint&&class=<?= $rowPretestMen['testClass'] ?>"><?= $rowPretestMen['testClass'] ?></a></td>
                    <td align="center">
                        <?php
...
<div class="col-lg-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            ?>
                <tr align="center">
                    <td align="center"><a href="?page=admissions&&admissionpage=filterPrint&&class=<?= $rowPretestWomen['testClass'] ?>"><?= $rowPretestWomen['testClass'] ?></a></td>
                    <td align="center">
                        <?php
