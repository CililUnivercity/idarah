<?php
    ...
    $sql_rc = "SELECT * FROM muqaddimah_pay WHERE m_id = (SELECT MAX(m_id) FROM muqaddimah_pay WHERE m_reciet!='')";
    ...
    $update = mysqli_query($con, "UPDATE students SET ft_id='$faculty',dp_id='$department',income_year='$cyear1',class='$cyear1',muqaddimah='1',password='2016' WHERE st_id='$st_id'");
?>
<script>
