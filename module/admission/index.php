  ...
  <div class="panel-body">
    <div class="pull-right">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="?page=admissions&&admissionpage=information">Laporan informasi</a></li>
                <li><a href="?page=admissions&&admissionpage=filterReport">Laporan persyaratan calon mahasiswa</a></li>
                <li><a href="?page=admissions&&admissionpage=schoolReport">Laporan sekolah calon mahasiswa</a></li>
            </ul>
        </div>
    ...
    $admissionpage = $_GET['admissionpage']; // To get the page
        ...
        switch ($admissionpage) {
            case'default':
                include 'module/admission/default.php';
                break;
            case'main':
            ...
            case'stdIdSave':
                ...
                break;
            case'filterReport':
                include 'module/admission/filterReport.php';
                break;
            case'filterReport':
                include 'module/admission/filterReport.php';
                break;
            case'filterReportSearch':
                include 'module/admission/function/filterReportSearch.php';
                break;
            case'information':
                include 'module/admission/information.php';
                break;
            case'reportInformation':
                include 'module/admission/reportInformation.php';
                break;
            case'filterPrint':
                include 'module/admission/filterPrint.php';
                break;
            case'schoolReport':
                include 'module/admission/schoolReport.php';
                break;
        }
    ?>
  </div>
