<?php
    ...
    $sql = "SELECT COUNT(st_id) FROM pretest WHERE testNumber='0' AND pre_register_year='$cyear1'";
    ...
    $sql = "SELECT s.*,p.* FROM students s INNER JOIN pretest p ON s.st_id=p.st_id WHERE testNumber='0' AND p.pre_register_year='$cyear1' ORDER BY regNumber $limit";
    $query = mysqli_query($con, $sql);
