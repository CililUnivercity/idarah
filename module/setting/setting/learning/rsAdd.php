...
<div class="pull-right">
    ...
    <a href="module/setting/setting/learning/print.php?ft_id=<?= $ft_id ?>&&dp_id=<?= $dp_id ?>" target="_blank" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print"></span> PRINT</a>
</div>
<br><br>
