<?php
    ...
    $s_credit = str_replace("\'", "&#39;", $rs['s_credit']);
?>
<br>
<div class='well'>
    <div class="pull-left">
    ...
    <form class="form-horizontal" action="?page=setting&&settingpage=saveEditSubject&&id=<?= $id ?>" enctype="multipart/form-data" method="POST">
       ...
       <div class="form-group">
            <label class="col-lg-2 control-label">KREDIT (SKS) :</label>
            <div class="col-lg-5">
                <input type="text" class="form-control input-sm" value='<?= $s_credit ?>' name="s_credit">
            </div>
       </div>
