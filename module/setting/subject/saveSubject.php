<?php
    ...
    $s_credit = mysqli_real_escape_string($con, $_POST['s_credit']);
...
<?php
        ...
        $insert = mysqli_query($con, "INSERT INTO subject
                (ft_id,s_code,s_arabName,s_rumiName,s_engName,s_thaiName,s_type,s_faculty,s_department,s_detail,s_credit) VALUES
                ('$ft_id','$s_code','$s_arabName','$s_rumiName','$s_engName','$s_thaiName','$s_type','$s_faculty','$s_department','$s_detail','$s_credit')
                ");
