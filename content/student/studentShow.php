...
?>
    ...
    <div id="myTabContent" class="tab-content">
        <div class="tab-pane fade active in" id="home">
            <p>
            <form class="form-horizontal" name="editStudentBachelor1" id="editStudentBachelor1">
                    <table>
                        <tr>
                            <td width="80%">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control input-sm" name="student_id" value="<?= $student_id ?>">
                                    </div>
                                </div>
			...
			<div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control input-sm" value="<?= $password ?>" name="password">
                            </div>
                        </div>
                    ...
                    <p class="text-center">
                        <button onclick="saveEditBachelor1()" class="btn btn-success btn-sm" name="save">SIMPAN</button>    
        ...
        <div class="tab-pane fade" id="profile">
            <p>
            <form class="form-horizontal" name="editStudentBachelor2" id="editStudentBachelor2">
                    <fieldset>
                        <legend>ส่วนที่ 1 : ข้อมูลทั่วไป</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control input-sm" value="<?= $t_province ?>" name="t_province">
                                </div>
                            </div>
                    ...
                    <fieldset>
                        <legend>ส่วนที่ 2 : ที่อยู่</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control input-sm" value="<?= $t_province_sec ?>" name="t_province_sec">
                                </div>
                            </div>
                ...
                <p class="text-center">
                    <button onclick="saveEditBachelor2()" class="btn btn-success btn-sm" name="save">SIMPAN</button>
        ...
        <div class="tab-pane fade" id="class">
            <br>
            <form class="form-horizontal" name="editStudentBachelor3" id="editStudentBachelor3" >
                    <?php
                          //Set year 
                          ...
                          if($kelas != $first){
                              $cnow = '4+';
                          }else if($kelas != $second){
                              $cnow = '4+';
                          }else if($kelas != $third){
                              $cnow = '4+';
                          }else if($kelas != $fordth){
                              $cnow = '4+';
                          }
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Kelas sekarang :</label>
                        <div class="col-lg-1">
            ...
            <p class="text-center">
                <button class="btn btn-success btn-sm" onclick="saveEditBachelor3()">SIMPAN</button>
                <div align="center" id="msg3"></div>
            </p>
        </div>
    </div> 
