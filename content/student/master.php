<?php
    include("../connect.php");
                    $pagic = "?page=student&&studentPage=master";
                    $sql = "SELECT COUNT(st_id) FROM students WHERE program!=''";
                    ...
                    $sql = "SELECT * FROM students WHERE program!='0' ORDER BY st_id DESC $limit";
                    $query = mysqli_query($con, $sql);
    ...
    <table class="table">
      <tbody>
        ...
        ?>
          ...
          <td align='left'>
                <b>NIM :</b> <font color='red'><?= $student_id ?></font> <br>
