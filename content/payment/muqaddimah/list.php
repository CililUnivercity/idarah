<h4>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-usd"></span> BAYAR MUQADDIMAH</h4>
<form class="form-horizontal" id="muqaddimahSearchForm" name="muqaddimahSearchForm">
    <div class="col-lg-3">
        <input type="text" class="form-control input-sm" name="q" id="q" autofocus onkeypress="return isPressEnterMuq()">
    </div>
</form>
<button type="submit" class="btn btn-success btn-sm" onclick="searchMuq()" id="searchBox">SEARCH</button>
<br><br>
...
?>
          <font color='green'><b>Sudah bayar</b></font>
<?php
    }else{
?>
